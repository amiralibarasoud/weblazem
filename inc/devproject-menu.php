<?php
/**
 * Add custom development page link to Appearance → Menus.
 */

function weblazem_devproject_nav_menu_meta_box() {
    add_meta_box(
        'weblazem-devproject-page-link',
        'صفحه برنامه نویسی و پروژه اختصاصی',
        'weblazem_devproject_nav_menu_meta_box_render',
        'nav-menus',
        'side',
        'default'
    );
}
add_action('admin_head-nav-menus.php', 'weblazem_devproject_nav_menu_meta_box');

function weblazem_devproject_nav_menu_meta_box_render() {
    global $_nav_menu_placeholder;

    $_nav_menu_placeholder = isset($_nav_menu_placeholder) ? (int) $_nav_menu_placeholder - 1 : -1;

    $url   = weblazem_get_devproject_page_url();
    $title = 'برنامه نویسی و پروژه اختصاصی';
    ?>
    <div id="weblazem-devproject-page-div" class="posttypediv">
        ...
        <p class="button-controls wp-clearfix">
            <span class="add-to-menu">
                <input type="submit" class="button-secondary submit-add-to-menu right"
                       ...
                       name="add-weblazem-devproject-page"
                       id="submit-weblazem-devproject-page">
