<?php
/**
 * Add pricing page link to Appearance → Menus.
 */

function weblazem_pricing_nav_menu_meta_box() {
    add_meta_box(
        'weblazem-pricing-page-link',
        'صفحه خدمات و تعرفه‌ها',
        'weblazem_pricing_nav_menu_meta_box_render',
        'nav-menus',
        'side',
        'default'
    );
}
add_action('admin_head-nav-menus.php', 'weblazem_pricing_nav_menu_meta_box');

function weblazem_pricing_nav_menu_meta_box_render() {
    global $_nav_menu_placeholder;

    $_nav_menu_placeholder = isset($_nav_menu_placeholder) ? (int) $_nav_menu_placeholder - 1 : -1;

    $url   = weblazem_get_pricing_page_url();
    $title = 'خدمات و تعرفه‌ها';
    ?>
    <div id="weblazem-pricing-page-div" class="posttypediv">
        ...
        <p class="button-controls wp-clearfix">
            <span class="add-to-menu">
                <input type="submit" class="button-secondary submit-add-to-menu right"
                       ...
                       name="add-weblazem-pricing-page"
                       id="submit-weblazem-pricing-page">
