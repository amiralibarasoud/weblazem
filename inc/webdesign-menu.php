<?php
/**
 * Add website design page link to Appearance → Menus.
 */

function weblazem_webdesign_nav_menu_meta_box() {
    add_meta_box(
        'weblazem-webdesign-page-link',
        'صفحه طراحی سایت',
        'weblazem_webdesign_nav_menu_meta_box_render',
        'nav-menus',
        'side',
        'default'
    );
}
add_action('admin_head-nav-menus.php', 'weblazem_webdesign_nav_menu_meta_box');

function weblazem_webdesign_nav_menu_meta_box_render() {
    ...
    $title = 'طراحی سایت';
    ?>
    <div id="weblazem-webdesign-page-div" class="posttypediv">
        ...
        <p class="button-controls wp-clearfix">
            <span class="add-to-menu">
                <input type="submit" class="button-secondary submit-add-to-menu right"
                       ...
                       name="add-weblazem-webdesign-page"
                       id="submit-weblazem-webdesign-page">
