<?php
/**
 * Shared FAQ + profile + service cards section.
 *
 * @param array $args prefix, id_prefix
 */

$prefix     = $args['prefix'] ?? 'webdesign';
$id_prefix  = $args['id_prefix'] ?? $prefix;
        ...
        <div class="webdesign-faq__top">
            <div class="webdesign-faq__questions">
                <div class="webdesign-faq__calligraphy">
                    <?php weblazem_render_service_calligraphy($prefix, 'faq_calligraphy_image', 'faq_calligraphy_text'); ?>
                </div>
                ...
                <?php if (!empty($faq_items)) : ?>
                    <div class="webdesign-faq__list" data-faq-accordion>
                        <?php foreach ($faq_items as $index => $item) :
                            $panel_id   = $id_prefix . '-faq-panel-' . (int) $index;
                            $trigger_id = $id_prefix . '-faq-trigger-' . (int) $index;
                            ?>
