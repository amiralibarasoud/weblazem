<?php
/**
 * Custom development — portfolio showcase.
 */

$subtitle    = weblazem_contentsupport_option('portfolio_subtitle', '');
$description = weblazem_contentsupport_option('portfolio_description', '');
$en_label    = weblazem_contentsupport_option('portfolio_en_label', 'Success Stories');
$tabs        = weblazem_get_contentsupport_portfolio_tabs();
$items       = weblazem_get_contentsupport_portfolio_items();
...
<section class="webdesign-portfolio" dir="rtl" id="contentsupport-portfolio">
    ...
    <div class="container">
        <header class="webdesign-portfolio__header">
            <div class="webdesign-portfolio__calligraphy">
                <?php weblazem_render_service_calligraphy('contentsupport', 'portfolio_calligraphy_image', 'portfolio_calligraphy_text'); ?>
            </div>
