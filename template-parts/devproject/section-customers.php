...
$logos         = get_option('weblazem_devproject_customers_logos', array());
$counter       = weblazem_devproject_option('customers_counter', '+120');
$counter_label = weblazem_devproject_option('customers_counter_label', 'SOFTWARE PROJECTS');
$bottom_icon   = weblazem_devproject_option('customers_bottom_icon', '');
    ...
    <div class="container">
        ...
        <div class="webdesign-customers__counter-row">
            <div class="webdesign-customers__calligraphy">
                <?php weblazem_render_service_calligraphy('devproject', 'customers_calligraphy_image', 'customers_calligraphy_text'); ?>
            </div>
