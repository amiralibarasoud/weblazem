...
$subtitle    = weblazem_devproject_option('portfolio_subtitle', '');
$description = weblazem_devproject_option('portfolio_description', '');
$en_label    = weblazem_devproject_option('portfolio_en_label', 'Success Stories');
$tabs        = weblazem_get_devproject_portfolio_tabs();
$items       = weblazem_get_devproject_portfolio_items();
...
<section class="webdesign-portfolio" dir="rtl" id="devproject-portfolio">
    ...
    <div class="container">
        <header class="webdesign-portfolio__header">
            <div class="webdesign-portfolio__calligraphy">
                <?php weblazem_render_service_calligraphy('devproject', 'portfolio_calligraphy_image', 'portfolio_calligraphy_text'); ?>
            </div>
