<?php
/**
 * Pricing page — consultation CTA footer.
 */

$title    = weblazem_pricing_option('consult_title', 'خدمات مشاوره');
$text     = weblazem_pricing_option('consult_text');
$btn_text = weblazem_pricing_option('consult_btn_text', 'مشاوره رایگان');
$btn_url  = weblazem_pricing_option('consult_btn_url', '');
$use_modal = weblazem_pricing_option('consult_btn_modal', '1') === '1';
?>

<section class="pricing-page-consult" dir="rtl">
