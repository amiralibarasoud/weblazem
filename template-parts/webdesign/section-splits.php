<?php
/**
 * Website design — two-column feature splits (corporate + store).
 */

$splits = get_option('weblazem_webdesign_splits', array());
...
<section class="webdesign-splits" dir="rtl">
    <div class="container">
        <?php foreach ($splits as $index => $split) :
            ...
            $default_img = get_template_directory_uri() . '/assets/images/webdesign/split-' . (($index % 2) + 1) . '.svg';
            ?>
